...
const OnlineMultiplayer = ({ goBack, onConnected }: Props) => {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center font-sans p-4 selection:bg-cyan-500/30 w-full h-full absolute inset-0">
            <button
                onClick={goBack}
